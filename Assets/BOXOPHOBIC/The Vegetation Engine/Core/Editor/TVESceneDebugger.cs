...
namespace TheVegetationEngine
{
    public class TVESceneDebugger : EditorWindow
    {
        ...
        {
        "Material Conversion", "Material Type", "Material Scope", "Material Lighting", "Material Sharing", "Texture Maps", "Texture Resolution", "Texture Mip Level", "Global Textures", "Mesh Attributes",
        };
