...
namespace TheVegetationEngine
{
    public class TVEMaterialManager : EditorWindow
    {
        ...
        List<TVEMaterialData> renderSettings = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_RenderSpecular", "Render Specular", -9999, "None 0 On 1", false),
            new TVEMaterialData("_RenderDecals", "Render Decals", -9999, "None 0 On 1", false),
            new TVEMaterialData("_RenderSSR", "Render SSR", -9999, "None 0 On 1", false),

            new TVEMaterialData("_RenderDirect", "Render Lighting", -9999, 0, 1, false, true),
            ...
            new TVEMaterialData("_RenderClip", "Alpha Clipping", -9999, "None 0 On 1", true),
            new TVEMaterialData("_RenderCoverage", "Alpha To Mask", -9999, "None 0 On 1", false),
            ...
            new TVEMaterialData("_FadeConstantValue", "Fade Constant", -9999, 0, 1, false, false),
            new TVEMaterialData("_FadeVerticalValue", "Fade Vertical", -9999, 0, 1, false, false),
            new TVEMaterialData("_FadeHorizontalValue", "Fade Horizontal", -9999, 0, 1, false, false),
            new TVEMaterialData("_FadeGlancingValue", "Fade Glancing", -9999, 0, 1, false, false),
            new TVEMaterialData("_FadeCameraValue", "Fade Distance", -9999, 0, 1, false, false),
        };
        ...
        List<TVEMaterialData> globalData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_GlobalOrientation", "Global Orientation", -9999, 0, 1, false, false),
            new TVEMaterialData("_GlobalConform", "Global Conform", -9999, 0, 1, false, false),
            ...
            new TVEMaterialData("_OverlayProjectionValue", "Overlay Projection", -9999, 0, 1, false, false),
            new TVEMaterialData("_ConformOffsetValue", "Conform Offset", -9999, -1, 1, false, false),

            new TVEMaterialData("_SpaceGlobalExtras"),
            ...
            new TVEMaterialData("_VertexPositionMode", "Use Pivot Position for Vertex", -9999, false),
        };
        ...
        List<TVEMaterialData> mainData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_MainAlphaValue", "Main Alpha", -9999, 0, 1, false, false),
            new TVEMaterialData("_MainAlbedoValue", "Main Albedo", -9999, 0, 1, false, false),
        ...
        List<TVEMaterialData> secondData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_DetailMode", "Detail Mode", -9999, "None 0 On 1", false),
            new TVEMaterialData("_DetailBlendMode", "Detail Blend", -9999, "Overlay 0 Replace 1", false),
            new TVEMaterialData("_DetailAlphaMode", "Detail Alpha", -9999, "Overlay 0 Replace 1", false),

            new TVEMaterialData("_DetailFadeMode", "Use Global Alpha and Fade", -9999, true),

            new TVEMaterialData("_SecondUVsMode", "Detail UVs", -9999, "Main_UVs 0 Detail_UVs 1 Planar_UVs 2", true),
            new TVEMaterialData("_SecondUVs", "Detail UVs", new Vector4(-9999, 0,0,0), false),

            new TVEMaterialData("_SecondColor", "Detail Color", new Color(-9999, 0,0,0), true, true),
            new TVEMaterialData("_SecondAlphaValue", "Detail Alpha", -9999, 0, 1, false, false),
            new TVEMaterialData("_SecondAlbedoValue", "Detail Albedo", -9999, 0, 1, false, false),
            ...
            new TVEMaterialData("_DetailMeshMode", "Detail Object Mode", -9999, "Vertex_Blue 0 Projection 1", true),
            new TVEMaterialData("_DetailMeshValue", "Detail Object Mask", -9999, 0, 1, false, false),
            new TVEMaterialData("_DetailMaskMode", "Detail Texture Mode", -9999, "Main_Mask 0 Detail_Mask 1", false),
            new TVEMaterialData("_DetailMaskValue", "Detail Texture Mask", -9999, 0, 1, false, false),
            ...
            new TVEMaterialData("_DetailMeshInvertMode", "Use Inverted Object Mask", -9999, true),
            new TVEMaterialData("_DetailMaskInvertMode", "Use Inverted Texture Mask", -9999, false),
        };
        ...
        List<TVEMaterialData> rimLightData = new List<TVEMaterialData>
        {
            new TVEMaterialData("_CategoryRimLight", "Rim Light Settings"),

            new TVEMaterialData("_RimLightColor", "Rim Light Color", new Color(-9999, 0,0,0), true, false),
            new TVEMaterialData("_RimLightMinValue", "Rim Light Min", -9999, 0, 1, false, false),
            new TVEMaterialData("_RimLightMaxValue", "Rim Light Max", -9999, 0, 1, false, false),
            new TVEMaterialData("_RimLightNormalValue", "Rim Light Normal", -9999, 0, 1, false, false),
        };
        ...
        List<TVEMaterialData> emissiveData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_EmissivePhaseMode", "Emissive Mode", -9999, "Fade_In 0 Fade_In_and_Out 1", false),
            new TVEMaterialData("_EmissiveIntensityMode", "Emissive Value", -9999, "Nits 0 EV100 1", false),
            new TVEMaterialData("_EmissiveFlagMode", "Emissive GI", -9999, "None 0 Any 1 Baked 2 Realtime 3", false),
            new TVEMaterialData("_EmissiveUVs", "Emissive UVs", new Vector4(-9999, 0,0,0), true),
            new TVEMaterialData("_EmissiveColor", "Emissive Color", new Color(-9999, 0,0,0), true, true),
            new TVEMaterialData("_EmissiveIntensityValue", "Emissive Intensity", -9999, false, false),
            new TVEMaterialData("_EmissiveWeightValue", "Emissive Weight", -9999, 0, 1, false, false),
            new TVEMaterialData("_EmissivePhaseValue", "Emissive Phase", -9999, 0, 1, false, false),
            new TVEMaterialData("_EmissiveAlphaValue", "Emissive Dissolve", -9999, 0, 1, false, false),
            new TVEMaterialData("_EmissiveDarkValue", "Emissive Darkening", -9999, 0, 1, false, false),
        };
        ...
        List<TVEMaterialData> motionData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_MotionHighlightColor", "Wind Highlight Color", new Color(-9999, 0,0,0), true, false),
            new TVEMaterialData("_MotionFacingValue", "Wind Direction Mask", -9999, 0, 1, false, false),

            new TVEMaterialData("_MotionAmplitude_10", "Motion Bending", -9999, 0, 2, false, true),
            new TVEMaterialData("_MotionPosition_10", "Motion Rigidity", -9999, 0, 1, false, false),
        ...
        void OnEnable()
        {
            ...
            materialData.AddRange(rimLightData);
        ...
        void DrawProperties()
        {
            ...
            {
                if (materialData[i].type == TVEMaterialData.PropertyType.Value)
                {
                    materialData[i].value = StyledValue(materialData[i].name, materialData[i].value, materialData[i].snap, materialData[i].space);
                }
                else if (materialData[i].type == TVEMaterialData.PropertyType.Range)
                {
        ...
        float StyledValue(string name, float val, bool snap, bool space)
        {
            ...
            else
            {
                ...
                if (val == -8888)
                {
                    ...
                    val = EditorGUILayout.FloatField(val, GUILayout.MaxWidth(GUI_HALF_EDITOR_WIDTH - 5));
        ...
        float StyledSlider(string name, float val, float min, float max, bool snap, bool space)
        {
            ...
            else
            {
                ...
                if (val == -8888)
                {
                    ...
                    mixedValue = GUILayout.HorizontalSlider(mixedValue, min, max, GUILayout.MaxWidth(GUI_HALF_EDITOR_WIDTH - 58));
                ...
                else
                {
                    ...
                    equalValue = GUILayout.HorizontalSlider(equalValue, min, max, GUILayout.MaxWidth(GUI_HALF_EDITOR_WIDTH - 58));
        ...
        void GetMaterialProperties()
        {
            for (int i = 0; i < selectedMaterials.Count; i++)
            {
                ...
                for (int d = 0; d < materialData.Count; d++)
                {
                    ...
                    {
                        if (!TVEUtils.GetPropertyVisibility(material, materialData[d].prop))
                        {
                            continue;
                        }
                    }
            ...
            if (GUILayout.Button("Save Preset", GUILayout.Height(GUI_HEIGHT)))
            {
                ...
                if (savePath != "")
                {
                    ...
                    if (savingIndex == 0)
                    {
                        ...
                        saveData.AddRange(rimLightData);
