// Upgrade NOTE: upgraded instancing buffer 'BOXOPHOBICTheVegetationEngineElementsDefaultExtrasWetness' to new syntax.
...
Shader "BOXOPHOBIC/The Vegetation Engine/Elements/Default/Extras Wetness"
{
	...
	LOD 0
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(BOXOPHOBICTheVegetationEngineElementsDefaultExtrasWetness)
				UNITY_DEFINE_INSTANCED_PROP(half4, _ElementParams)
#define _ElementParams_arr BOXOPHOBICTheVegetationEngineElementsDefaultExtrasWetness
			UNITY_INSTANCING_BUFFER_END(BOXOPHOBICTheVegetationEngineElementsDefaultExtrasWetness)
			...
			v2f vert ( appdata v )
			{
				...
				half vertexToFrag11_g21048 = ( ( ( TVE_SeasonOptions_X50_g21017 * lerpResult168_g21017 ) + ( TVE_SeasonOptions_Y51_g21017 * lerpResult167_g21017 ) ) + ( ( TVE_SeasonOptions_Z52_g21017 * lerpResult166_g21017 ) + ( TVE_SeasonOptions_W53_g21017 * lerpResult165_g21017 ) ) );
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half Value_Seasons1721_g21017 = vertexToFrag11_g21048;
				half Element_Mode55_g21017 = _ElementMode;
				half lerpResult181_g21017 = lerp( Value_Main157_g21017 , Value_Seasons1721_g21017 , Element_Mode55_g21017);
				half4 MainTex_RGBA587_g21017 = tex2D( _MainTex, ( ( ( 1.0 - i.ase_texcoord1.yz ) * (_MainUVs).xy ) + (_MainUVs).zw ) );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g21058 = clamp( (MainTex_RGBA587_g21017).rgb , temp_cast_0 , temp_cast_1 );
				...
				half3 temp_output_1765_0_g21017 = saturate( ( ( clampResult17_g21058 - temp_cast_2 ) / temp_output_10_0_g21071 ) );
				half Element_Remap_R73_g21017 = (temp_output_1765_0_g21017).x;
				half4 _ElementParams_Instance = UNITY_ACCESS_INSTANCED_PROP(_ElementParams_arr, _ElementParams);
				half Element_Params_R1738_g21017 = _ElementParams_Instance.x;
				half Element_Value1744_g21017 = ( Element_Remap_R73_g21017 * Element_Params_R1738_g21017 * i.ase_color.r );
				half Final_Extras_RGB213_g21017 = ( lerpResult181_g21017 * Element_Value1744_g21017 );
				half clampResult17_g21057 = clamp( (MainTex_RGBA587_g21017).a , 0.0001 , 0.9999 );
				...
				half Element_Remap_A74_g21017 = saturate( ( ( clampResult17_g21057 - temp_output_7_0_g21059 ) / ( temp_output_10_0_g21059 + 0.0001 ) ) );
				half Element_Params_A1737_g21017 = _ElementParams_Instance.w;
				...
				half lerpResult842_g21017 = lerp( 1.0 , ( 1.0 - saturate( ( (temp_output_12_0_g21072).x + (temp_output_12_0_g21072).y ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g21017 = ( _ElementIntensity * Element_Remap_A74_g21017 * Element_Params_A1737_g21017 * i.ase_color.a * lerpResult842_g21017 );
				half Final_Extras_A241_g21017 = Element_Alpha56_g21017;
				half4 appendResult475_g21017 = (half4(0.0 , Final_Extras_RGB213_g21017 , 0.0 , Final_Extras_A241_g21017));
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.FunctionNode;124;-256,-1536;Inherit;False;Define Element Extras;67;;20889;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;80,-1280;Half;False;True;-1;2;TVEShaderElementGUI;0;5;BOXOPHOBIC/The Vegetation Engine/Elements/Default/Extras Wetness;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;True;2;5;False;;10;False;;0;2;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;True;True;False;True;False;False;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;4;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;DisableBatching=True=DisableBatching;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;False;0
...
Node;AmplifyShaderEditor.FunctionNode;140;-256,-1280;Inherit;False;Base Element;2;;21017;0e972c73cae2ee54ea51acc9738801d0;4,477,1,478,0,145,1,481,0;0;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;115;0,-1536;Half;False;Property;_Banner;Banner;0;0;Create;True;0;0;0;False;1;StyledBanner(Wetness Element);False;0;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;141;384,-1536;Inherit;False;Compile All Elements;-1;;21472;5302407fc6d65554791e558e67d59358;0;0;1;FLOAT;0
WireConnection;0;0;140;0
ASEEND*/
//CHKSM=77ED55EA7BD8666AECCE8DE9632B206E92E1B3C8