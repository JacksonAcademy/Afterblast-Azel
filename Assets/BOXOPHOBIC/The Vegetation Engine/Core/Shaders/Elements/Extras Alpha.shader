// Upgrade NOTE: upgraded instancing buffer 'BOXOPHOBICTheVegetationEngineElementsDefaultExtrasAlpha' to new syntax.
...
Shader "BOXOPHOBIC/The Vegetation Engine/Elements/Default/Extras Alpha"
{
	...
	LOD 0
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(BOXOPHOBICTheVegetationEngineElementsDefaultExtrasAlpha)
				UNITY_DEFINE_INSTANCED_PROP(half4, _ElementParams)
#define _ElementParams_arr BOXOPHOBICTheVegetationEngineElementsDefaultExtrasAlpha
			UNITY_INSTANCING_BUFFER_END(BOXOPHOBICTheVegetationEngineElementsDefaultExtrasAlpha)
			...
			v2f vert ( appdata v )
			{
				...
				half TVE_SeasonOptions_X50_g20938 = TVE_SeasonOptions.x;
				half Value_Winter158_g20938 = _AdditionalValue1;
				half Value_Spring159_g20938 = _AdditionalValue2;
				half TVE_SeasonLerp54_g20938 = TVE_SeasonLerp;
				half lerpResult168_g20938 = lerp( Value_Winter158_g20938 , Value_Spring159_g20938 , TVE_SeasonLerp54_g20938);
				half TVE_SeasonOptions_Y51_g20938 = TVE_SeasonOptions.y;
				half Value_Summer160_g20938 = _AdditionalValue3;
				half lerpResult167_g20938 = lerp( Value_Spring159_g20938 , Value_Summer160_g20938 , TVE_SeasonLerp54_g20938);
				half TVE_SeasonOptions_Z52_g20938 = TVE_SeasonOptions.z;
				half Value_Autumn161_g20938 = _AdditionalValue4;
				half lerpResult166_g20938 = lerp( Value_Summer160_g20938 , Value_Autumn161_g20938 , TVE_SeasonLerp54_g20938);
				half TVE_SeasonOptions_W53_g20938 = TVE_SeasonOptions.w;
				half lerpResult165_g20938 = lerp( Value_Autumn161_g20938 , Value_Winter158_g20938 , TVE_SeasonLerp54_g20938);
				half vertexToFrag11_g21048 = ( ( ( TVE_SeasonOptions_X50_g20938 * lerpResult168_g20938 ) + ( TVE_SeasonOptions_Y51_g20938 * lerpResult167_g20938 ) ) + ( ( TVE_SeasonOptions_Z52_g20938 * lerpResult166_g20938 ) + ( TVE_SeasonOptions_W53_g20938 * lerpResult165_g20938 ) ) );
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				half Value_Main157_g20938 = _MainValue;
				half vertexToFrag11_g21048 = i.ase_texcoord1.x;
				half Value_Seasons1721_g20938 = vertexToFrag11_g21048;
				half Element_Mode55_g20938 = _ElementMode;
				half lerpResult181_g20938 = lerp( Value_Main157_g20938 , Value_Seasons1721_g20938 , Element_Mode55_g20938);
				half4 MainTex_RGBA587_g20938 = tex2D( _MainTex, ( ( ( 1.0 - i.ase_texcoord1.yz ) * (_MainUVs).xy ) + (_MainUVs).zw ) );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g21058 = clamp( (MainTex_RGBA587_g20938).rgb , temp_cast_0 , temp_cast_1 );
				...
				half3 temp_output_1765_0_g20938 = saturate( ( ( clampResult17_g21058 - temp_cast_2 ) / temp_output_10_0_g21071 ) );
				half Element_Remap_R73_g20938 = (temp_output_1765_0_g20938).x;
				half4 _ElementParams_Instance = UNITY_ACCESS_INSTANCED_PROP(_ElementParams_arr, _ElementParams);
				half Element_Params_R1738_g20938 = _ElementParams_Instance.x;
				half Element_Value1744_g20938 = ( Element_Remap_R73_g20938 * Element_Params_R1738_g20938 * i.ase_color.r );
				half Final_Extras_RGB213_g20938 = ( lerpResult181_g20938 * Element_Value1744_g20938 );
				half clampResult17_g21057 = clamp( (MainTex_RGBA587_g20938).a , 0.0001 , 0.9999 );
				...
				half Element_Remap_A74_g20938 = saturate( ( ( clampResult17_g21057 - temp_output_7_0_g21059 ) / ( temp_output_10_0_g21059 + 0.0001 ) ) );
				half Element_Params_A1737_g20938 = _ElementParams_Instance.w;
				...
				half lerpResult842_g20938 = lerp( 1.0 , ( 1.0 - saturate( ( (temp_output_12_0_g21072).x + (temp_output_12_0_g21072).y ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g20938 = ( _ElementIntensity * Element_Remap_A74_g20938 * Element_Params_A1737_g20938 * i.ase_color.a * lerpResult842_g20938 );
				half lerpResult1634_g20938 = lerp( 1.0 , Final_Extras_RGB213_g20938 , Element_Alpha56_g20938);
				half Element_BlendA918_g20938 = _ElementBlendA;
				half lerpResult933_g20938 = lerp( lerpResult1634_g20938 , ( Final_Extras_RGB213_g20938 * Element_Alpha56_g20938 ) , Element_BlendA918_g20938);
				half Final_Extras_Blend211_g20938 = lerpResult933_g20938;
				half4 appendResult472_g20938 = (half4(0.0 , 0.0 , 0.0 , Final_Extras_Blend211_g20938));
				
				
				finalColor = appendResult472_g20938;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.FunctionNode;106;-640,-1408;Inherit;False;Define Element Extras;69;;20937;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;137;-640,-1152;Inherit;False;Base Element;2;;20938;0e972c73cae2ee54ea51acc9738801d0;4,477,1,478,0,145,3,481,0;0;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;112;-640,-1280;Inherit;False;Property;_render_src;_render_src;67;1;[HideInInspector];Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;113;-480,-1280;Inherit;False;Property;_render_dst;_render_dst;68;1;[HideInInspector];Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;101;-384,-1408;Half;False;Property;_Banner;Banner;0;0;Create;True;0;0;0;False;1;StyledBanner(Alpha Element);False;0;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;138;0,-1408;Inherit;False;Compile All Elements;-1;;21472;5302407fc6d65554791e558e67d59358;0;0;1;FLOAT;0
WireConnection;0;0;137;0
ASEEND*/
//CHKSM=984566834FD88472798F44D5194122817DB15FA2