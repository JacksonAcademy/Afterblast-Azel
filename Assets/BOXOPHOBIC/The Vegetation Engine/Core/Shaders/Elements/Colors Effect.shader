...
#define _ElementParams_arr BOXOPHOBICTheVegetationEngineElementsDefaultColorsEffect
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half lerpResult1634_g21473 = lerp( 1.0 , Final_Extras_RGB213_g21473 , Element_Alpha56_g21473);
				half Element_BlendA918_g21473 = _ElementBlendA;
				half lerpResult933_g21473 = lerp( lerpResult1634_g21473 , ( Final_Extras_RGB213_g21473 * Element_Alpha56_g21473 ) , Element_BlendA918_g21473);
				half Final_Extras_Blend211_g21473 = lerpResult933_g21473;
				half4 appendResult1622_g21473 = (half4(0.0 , 0.0 , 0.0 , Final_Extras_Blend211_g21473));
				
				
				finalColor = appendResult1622_g21473;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.RangedFloatNode;205;-640,-640;Inherit;False;Property;_render_src;_render_src;69;1;[HideInInspector];Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;206;-480,-640;Inherit;False;Property;_render_dst;_render_dst;70;1;[HideInInspector];Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;232;-640,-512;Inherit;False;Base Element;2;;21473;0e972c73cae2ee54ea51acc9738801d0;4,477,0,478,3,145,3,481,0;0;1;FLOAT4;0
WireConnection;0;0;232;0
ASEEND*/
//CHKSM=C5F9AB47BBAF20B173A1ADC70F52A53AA61B12B4