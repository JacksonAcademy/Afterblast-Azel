...
{
    public class TriplanarMaterialSimpleXYZ : TriplanarMaterial
    {
        // X
...
#if UNITY_EDITOR
    [CustomEditor(typeof(TriplanarMaterialSimpleXYZ))]
    public class TriplanarMaterialSimpleXYZEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            base.OnInspectorGUI();

            var setter = target as TriplanarMaterialSimpleXYZ;
