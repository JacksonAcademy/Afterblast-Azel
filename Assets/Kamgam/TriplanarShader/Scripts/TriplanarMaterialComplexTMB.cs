...
{
    public class TriplanarMaterialComplexTMB : TriplanarMaterial
    {
        // Main
...
#if UNITY_EDITOR
    [CustomEditor(typeof(TriplanarMaterialComplexTMB))]
    public class TriplanarMaterialComplexTMBEditor : Editor
    {
