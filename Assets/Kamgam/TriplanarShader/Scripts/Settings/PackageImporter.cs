...
namespace Kamgam.TriplanarShader
{
    public static class PackageImporter
    {
        ...
        {
			new Package( RenderPiplelineType.URP,  "Assets/Kamgam/TriplanarShader/Packages/TriplanarShaderURP.unitypackage" ),
            new Package( RenderPiplelineType.HDRP, "Assets/Kamgam/TriplanarShader/Packages/TriplanarShaderHDRP.unitypackage" )
        };
        ...
        [MenuItem("Tools/Triplanar Shader/Debug/Import Packages", priority = 200)]
